...
# The fleet application is not a pip package: `fleet/` is imported from the
# checkout, and the tools under bin/ are read (never executed) by _ext/tooldoc.
...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/cameronabrams/fleet",
            "html": """
