...
REPORTED and VERIFIED in the fleet, 2026-09-16: Claude Code killed a session's background
...
be right (checked 2026-09-16). `setsid -f`, or a caller that is a process-group leader,
